...
class ContaBancaria:
    ...
    def __init__(self, numero, saldo=0):
        ...
        self.__saldo = saldo
        self.__cliente = None
        ContaBancaria.__contas.append(self)

    def vincular_cliente(self, cliente):
        if cliente in [conta.__cliente for conta in ContaBancaria.__contas]:
            raise ValueError('Cliente já vinculado a conta')
    ...
    def __str__(self):
        return f"Conta: {self.__numero} (Saldo: {self.__saldo})"